...
})(window,document,'script','dataLayer','GTM-KVX24D');</script>
<!-- End Google Tag Manager -->

    <!-- Chrome, Firefox OS, Opera and Vivaldi -->
    <meta name="theme-color" content="#262b28">
    <!-- Windows Phone -->
    <meta name="msapplication-navbutton-color" content="#262b28">
    <!-- iOS Safari -->
    <meta name="apple-mobile-web-app-status-bar-style" content="#262b28">
    <meta charset="utf-8">
...
<!-- Hotjar Tracking Code for http://santissimavestimenta.com.br -->
<script>
    (function(h,o,t,j,a,r){
        h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
        h._hjSettings={hjid:498711,hjsv:5};
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KVX24D"
    ...
    <div class="page-wrapper<?php if ($header_type == 'side') echo ' side-nav' ?>"><!-- page wrapper -->
        ...
        <?php if (porto_get_meta_value('header', true)) : ?>
            <div class="header-wrapper<?php if ($porto_settings['header-wrapper'] == 'wide') echo ' wide' ?><?php if (!($header_type == 'side' && $wrapper == 'boxed') && ($porto_banner_pos == 'below_header' || $porto_banner_pos == 'fixed')) { echo ' fixed-header'; if ($porto_settings['header-fixed-show-bottom']) echo ' header-transparent-bottom-border'; } ?><?php if ($header_type == 'side') echo ' header-side-nav' ?> clearfix"><!-- header wrapper -->
                ...
                global $post;
                if ( $post->ID == 8761 ) {
                    get_template_part('header/header_18.php');
                } else {
