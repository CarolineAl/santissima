...
if ( ! function_exists( 'woocommerce_template_single_meta_cat' ) ) {

	/**
	 * Output the product meta categories.
	 *
	 * @subpackage	Product
	 */
	function woocommerce_template_single_meta_cat() {
		wc_get_template( 'single-product/meta_cat.php' );
	}
}
