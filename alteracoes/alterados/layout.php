...
function porto_top_navigation() {
    ...
    if (isset($porto_settings['menu-login-pos']) && $porto_settings['menu-login-pos'] == 'top_nav') {
        if (is_user_logged_in()) {
            ...
            global $current_user;
            get_currentuserinfo();
            //echo '<div class="saudacao">Olá, ' . $current_user->user_firstname . '</div>';
            $html .= '<li id="saudacao" class="menu-item">Olá, ' . $current_user->user_firstname . '</li>';

            $url_conta= get_site_url();
            $html .= "<li class='menu-item'><a href='$url_conta/minha-conta' >Minha Conta</a></li>";
            ...
            $html .= '<li class="menu-item"><a href="' . $logout_link . '">' . __('Logout', 'porto') . '</a></li>';
        } else {
